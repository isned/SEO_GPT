...
print(os.environ.get("OPENAI_API_KEY"))  # This should print your API key
def main():
...
print(os.environ.get("OPENAI_API_KEY"))  # Vérifier que la clé API est correctement chargée
...
def main():
    ...
    if len(saved_articles) == 0:
        ...
        logging.info(f"Skipping scraping as the output folder contains {len(saved_articles)} articles.")
    ...
    for article in saved_articles:
        ...
        time.sleep(20)  # Attendre avant de traiter le prochain article
